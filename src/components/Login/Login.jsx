...
const Login = () => {
  ...
  return (
    ...
    <div className="hero bg-gray-800 min-h-screen">
      <div className="hero-content flex-col lg:flex-row-reverse" style={{fontFamily: 'Chillax'}}>
      ...
      <button className="btn btn-accent" onClick={()=>history.push('/register')}>Register</button>
      </div>
      </div>
      </div>
      </div>
